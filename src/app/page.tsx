      ...
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-green-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            ...
            <a
              href="/blog/posts"
              className={`outline outline-1 outline-offset-2 border-green-500 text-green-500 hover:text-white py-2 px-4 rounded hover:bg-green-500 md:w-auto ${styles.fit_content}`}
            >
              Go to Blog
            </a>
          </div>
